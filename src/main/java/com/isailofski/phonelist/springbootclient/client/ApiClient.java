package com.isailofski.phonelist.springbootclient.client;
...
import com.isailofski.phonelist.springbootclient.client.auth.Authentication;
import com.isailofski.phonelist.springbootclient.client.auth.HttpBasicAuth;
import com.isailofski.phonelist.springbootclient.client.auth.HttpBearerAuth;
import com.isailofski.phonelist.springbootclient.client.auth.ApiKeyAuth;
...
@Component("com.isailofski.phonelist.springbootclient.client.ApiClient")
public class ApiClient {
    ...
    public <T> ResponseEntity<T> invokeAPI(String path, HttpMethod method, MultiValueMap<String, String> queryParams,
            Object body, HttpHeaders headerParams, MultiValueMap<String, String> cookieParams,
     ...
     * <a href="https://tools.ietf.org/html/rfc6265#section-5.3">
