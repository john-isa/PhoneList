 ...
 */
@ApiModel(description = "a list of all the telephone numbers created")
...
public class PostPhoneNumberListResponseDto {
  @JsonProperty("result")
  ...
  public PostPhoneNumberListResponseDto result(RequestResultDto result) {
    this.result = result;
    return this;
  }
  ...
  public PostPhoneNumberListResponseDto phoneDetails(List<PhoneNumberDetailsDto> phoneDetails) {
    this.phoneDetails = phoneDetails;
    return this;
  }

  public PostPhoneNumberListResponseDto addPhoneDetailsItem(PhoneNumberDetailsDto phoneDetailsItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PostPhoneNumberListResponseDto postPhoneNumberListResponse = (PostPhoneNumberListResponseDto) o;
    return Objects.equals(this.result, postPhoneNumberListResponse.result) &&
        Objects.equals(this.phoneDetails, postPhoneNumberListResponse.phoneDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostPhoneNumberListResponseDto {\n");
